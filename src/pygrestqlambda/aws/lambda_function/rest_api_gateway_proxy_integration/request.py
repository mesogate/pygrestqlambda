...
class Request:
    ...
    def __init__(self, event: dict):
        ...
        self.accept_header: str = self.get_header('accept')
        self.content_type_header: str = self.get_header('content-type')
        # Extract resource
    ...
    def get_header(self, header_name: str):
        """
        Retrieve header value, performs lowercase lookup
        """
        ...
        header = headers_lower.get(header_name.lower())
